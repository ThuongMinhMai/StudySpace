      ...
      >
        <Link to='/detail'>
          <Card
            ...
            cover={
              <div className='relative'>
                <div className='cardrelated text-base font-bold' data-label={`From: ${price}$`}>
                  <div className=' relative overflow-hidden '>
                    <img
                      alt={title}
                      src={imgSrc}
                      className='h-40 w-full object-cover transition-transform duration-300 ease-in-out hover:scale-105 z-[100]'
                    />
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <button className='w-full mt-5 py-2 text-base rounded-md font-medium border-2 border-[#647C6C] text-[#647C6C] hover:bg-[#647C6C] hover:text-white transition-all'>
              Book Now
            </button>
          </Card>
        </Link>
