      ...
      <header className="header">
        <nav className=' '>
          <div className="nav__bar">
            <div className="">
            <p className='font-goodvibrations text-5xl bg-gradient-to-r from-[#464C52] to-[#D1C6B9] bg-clip-text text-transparent'>StudySpace</p>
        ...
        <div className="section__container header__container" id="home">
          ...
          <h1>Find Your Flow: <span>Study</span>,<span> Meet</span><br /> and <span>Sip Coffee</span>. </h1>
        </div>
      </header>
    ...
    <footer className="footer" id="contact">
      <div className="section__container footer__container">
        <div className="footer__col">
          <div className="">
            {/* <a href="#home"><img src={logoMini} alt="logo" /></a> */}
            <p className='font-goodvibrations text-3xl bg-gradient-to-r from-[#464C52] to-[#C6A083] bg-clip-text text-transparent'>StudySpace</p>
