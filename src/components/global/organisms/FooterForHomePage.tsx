      ...
      <div className='section__container footer__container grid gap-y-16 gap-x-8'>
        ...
        <div className='footer__col'>
          ...
          <ul className='footer__links list-none grid gap-4'>
            <li>
              <a className='transition-colors duration-300 hover:text-[#647C6C] '>Browse Destinations</a>
            </li>
            <li>
              <a className='transition-colors duration-300 hover:text-[#647C6C] '>Special Offers & Packages</a>
            </li>
            <li>
              <a className='transition-colors duration-300 hover:text-[#647C6C] '>Room Types & Amenities</a>
            </li>
          </ul>
        </div>
        <div className='footer__col'>
          ...
          <ul className='footer__links list-none grid gap-4'>
            <li>
              <a className='transition-colors duration-300 hover:text-[#647C6C] '>Concierge Assistance</a>
            </li>
            <li>
              <a className='transition-colors duration-300 hover:text-[#647C6C] '>Flexible Booking Options</a>
            </li>
            <li>
              <a className='transition-colors duration-300 hover:text-[#647C6C] '>Airport Transfers</a>
            </li>
          </ul>
        </div>
        <div className='footer__col'>
          ...
          <ul className='footer__links list-none grid gap-4'>
            ...
            <li>
              <a className='transition-colors duration-300 hover:text-[#647C6C] flex justify-start items-center'>
